 ...
 */
 ...
 Vue.component('userdashboard', require('./components/UserComponents/UserDashboardComponent.vue').default);
 Vue.component('usercreate', require('./components/UserComponents/UserCreateComponent.vue').default);
 const app = new Vue({
    el: '#app',
    data:{ 
      menu:0
